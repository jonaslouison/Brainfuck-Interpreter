...
#Sets up the following: a d w s UI 255 Enter 0 . width=8 height=8 tempPos=1 Pos=1 ; with same functionality as mycode22
#todo >> Version 3 with less fields used, == more logic needed
mycode23 = str(">>>>>>++++++++++[<+<+<+++++<+++++<+[>]<-]+.>+.<<--.<--.<----.<--.<<-.[<,<<<<<++++++++++[>++++++++++>++++++++++>++++++++++++>++++++++++++[<]>-]>--->>->----->[<-<-<-<->>>>-]<<<<<+<+<+<+>>>>[[-]<<<<->>>>]>[[-]<<<<->>>>]>[[-]<<<<->>>>]>[[-]<<<<->>>>]<<<<<<<"+
"[++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.[-]]>[+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.[-]]>[++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.[-]]>[++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.[-]]>>>>>-]")
