...
mycode18 = str("<++++++++[[>]>++++++++[<++++++>-]+<--[<]>-]>++>-<<-[<,<[-]<[-]++++++++[>++++++++<-]>+[>-<-]+>[<->[-]>>>[>>]<-->+>++>-<[<]]<[->>>>[>>]+<--<-<++[<]<]>>>[.>>]<<[<<]>-]")
# Creates bounderies (adds one 0 at each end), looks like this "A UI 255 0 0 NUL . SOH ...0" now
mycode19 = str("+<++++++++[[>]>++++++++[<++++++>-]+<--[<]>-].>.->++>-<<-[<,<[-]<[-]++++++++[>++++++++<-]>+[>-<-]+>[<->[-]>>>[>>]<-->+>++>-<[<]]<[->>>>[>>]+<--<-<++[<]<]>>>[.>>]<<[<<]>-]")

#Set 0 to the verry left if it passed the rigth boundarry
mycode20 = str("<++++++++[[>]>++++++++[<++++++>-]+<--[<]>-]>++>-<<-[<,<[-]<[-]++++++++[>++++++++<-]>+[>-<-]+>[<->[-]>>>[>>]<-->+>++>-<[<]]<[->>>>[>>]+<--<-<++[<]<]>>>[.>>]<<[<<]>-]")

#? Little Game 2D > Move 0 with wasd; Ascii: "."= 46, "0"= 48, "Enter"= 10, "a"=97, "d"= 100, "w"= 120, "s"= 115
#Sets up the following: a d w s UI 255
mycode21 = str("-[<,<<<<<++++++++++[>++++++++++>++++++++++>++++++++++++>++++++++++++[<]>-]>---.[-]>.[-]>-.[-]>-----.[-]>.>.-]")
#todo ^^ shorter setup

#detect which key was pressed and prints the capital letter of it eg. the input = a then the output = A, same for w,d,s; other keys dont print anything
mycode22 = str("-[<,<<<<<++++++++++[>++++++++++>++++++++++>++++++++++++>++++++++++++[<]>-]>--->>->----->[<-<-<-<->>>>-]"+
"<<<<<+<+<+<+>>>>[[-]<<<<->>>>]>[[-]<<<<->>>>]>[[-]<<<<->>>>]>[[-]<<<<->>>>]<<<<<<<"+
"[++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.[-]]>"+
"[+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.[-]]>"+
...
#Sets up the following: a d w s UI 255 0NUL.SOH.SOH.SOH.SOH.SOH.SOH.SOH Enter SOT .SOH (64 fieldsize) with same functionality as mycode22
mycode23 = str("-<<++++++++[>++++++++[[>]>++++++++[<++++++>-]+<--[<]>>-]+[>]++++++++++>++[<]>>-<-]>>>++>-<<"+
"[<,<<<<<++++++++++[>++++++++++>++++++++++>++++++++++++>++++++++++++[<]>-]>--->>->----->[<-<-<-<->>>>-]"+
"<<<<<+<+<+<+>>>>[[-]<<<<->>>>]>[[-]<<<<->>>>]>[[-]<<<<->>>>]>[[-]<<<<->>>>]<<<<<<<"+
"[++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.[-]]>"+
...
#Sets up everything like mycode 23 + Logic for keys a & d; w & s print capital Letter of itself
mycode24 = str("-<<++++++++[>++++++++[[>]>++++++++[<++++++>-]+<--[<]>>-]+[>]++++++++++>++[<]>>-<-]>>>++>-<<"+
"[<,<<<<<++++++++++[>++++++++++>++++++++++>++++++++++++>++++++++++++[<]>-]>--->>->----->[<-<-<-<->>>>-]"+
"<<<<<+<+<+<+>>>>[[-]<<<<->>>>]>[[-]<<<<->>>>]>[[-]<<<<->>>>]>[[-]<<<<->>>>]<<<<<<<"+
"[>>>>>>>>>[>]+<--<-<++[<]<<<<<<<<[-]]>"+
...
#Sets up everything like mycode 24 + Logic for all Keys adws
mycode25 = str("-<<++++++++[>++++++++[[>]>++++++++[<++++++>-]+<--[<]>>-]+[>]++++++++++>++[<]>>-<-]>>>++>-<<"+
"[<,<<<<<++++++++++[>++++++++++>++++++++++>++++++++++++>++++++++++++[<]>-]>--->>->----->[<-<-<-<->>>>-]"+
"<<<<<+<+<+<+>>>>[[-]<<<<->>>>]>[[-]<<<<->>>>]>[[-]<<<<->>>>]>[[-]<<<<->>>>]<<<<<<<"+
"[>>>>>>>>>[>]+<--<-<++[<]<<<<<<<<[-]]>"+
...
#Sets up everything like mycode 25 + Logic for Key a > Move to the very right if a is pressed at the very left; moves > 18
mycode26 = str("-<<++++++++[>++++++++[[>]>++++++++[<++++++>-]+<--[<]>>-]+[>]++++++++++>++[<]>>-<-]>>>++>-<<"+
"[<,<<<<<++++++++++[>++++++++++>++++++++++>++++++++++++>++++++++++++[<]>-]>--->>->----->[<-<-<-<->>>>-]"+
"<<<<<+<+<+<+>>>>[[-]<<<<->>>>]>[[-]<<<<->>>>]>[[-]<<<<->>>>]>[[-]<<<<->>>>]<<<<<<<"+
"[>>>>>>>>>[>]+<--<-[+>>>>>>>>>>>>>>>>-]<++[<]<<<<<<<<[-]]>"+
...
#Sets up everything like mycode 26 + Logic for Key d > Move to the very left if d is pressed at the very right; moves < 18
mycode27 = str("-<<++++++++[>++++++++[[>]>++++++++[<++++++>-]+<--[<]>>-]+[>]++++++++++>++[<]>>-<-]>>>++>-<<"+
"[<,<<<<<++++++++++[>++++++++++>++++++++++>++++++++++++>++++++++++++[<]>-]>--->>->----->[<-<-<-<->>>>-]"+
"<<<<<+<+<+<+>>>>[[-]<<<<->>>>]>[[-]<<<<->>>>]>[[-]<<<<->>>>]>[[-]<<<<->>>>]<<<<<<<"+
"[>>>>>>>>>[>]+<--<-[+>>>>>>>>>>>>>>>>-]<++[<]<<<<<<<<[-]]>"+
...
#Sets up everything like mycode 27 + Logic for Key w > Move to the bottom if w is pressed at the top; moves > 126 = 18*7
mycode28 = str("-<<++++++++[>++++++++[[>]>++++++++[<++++++>-]+<--[<]>>-]+[>]++++++++++>++[<]>>-<-]>>>++>-<<"+
"[<,<<<<<++++++++++[>++++++++++>++++++++++>++++++++++++>++++++++++++[<]>-]>--->>->----->[<-<-<-<->>>>-]"+
"<<<<<+<+<+<+>>>>[[-]<<<<->>>>]>[[-]<<<<->>>>]>[[-]<<<<->>>>]>[[-]<<<<->>>>]<<<<<<<"+
"[>>>>>>>>>[>]+<--<-[+>>>>>>>>>>>>>>>>-]<++[<]<<<<<<<<[-]]>"+
...
#Sets up everything like mycode 28 + Logic for Key s > Move to the top if s is pressed at the bottom; moves < 126 = 18*7
