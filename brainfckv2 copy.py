...
#? Little Game 2D > Move 0 with wasd; Ascii: "."= 46, "0"= 48, "new Line"= 10, "a"=97, "d"= 100, "w"= 120, "s"= 115
#Sets up the following: a d w s UI 255
mycode21 = str("-[<,<<<<<++++++++++[>++++++++++>++++++++++>++++++++++++>++++++++++++[<]>-]>---.[-]>.[-]>-.[-]>-----.[-]>.>.-]")
#todo ^^ shorter setup

#detect which key was pressed and prints the capital letter of it eg. input is a output is A, same for w,d,s; other keys dont print anything
mycode22 = str("-[<,<<<<<++++++++++[>++++++++++>++++++++++>++++++++++++>++++++++++++[<]>-]>--->>->----->[<-<-<-<->>>>-]<<<<<+<+<+<+>>>>[[-]<<<<->>>>]>[[-]<<<<->>>>]>[[-]<<<<->>>>]>[[-]<<<<->>>>]<<<<<<<"+
"[++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.[-]]>[+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.[-]]>[++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.[-]]>[++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++.[-]]>>>>>-]")

#Sets up the following: a d w s UI 255 Enter 0 . width=8 height=8 tempPos=1 Pos=1
